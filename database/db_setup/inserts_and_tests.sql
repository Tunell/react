...
INSERT INTO material_has_meta (meta_material_id, material_id, recycle_class_id, unit_id, amount)
VALUES (1, 1, 1, 1, 4);
...
INSERT INTO composite_has_material (composite_material_id, material_id, recycle_class_id, unit_id, amount)
VALUES (1, 1, 2, 2, 1),
       (2, 2, 1, 1, 1),
       (3, 1, 1, 1, 1),
       (3, 2, 1, 1, 1);
