...
INSERT INTO material (user_id, name, unit_id)
VALUES (1, "Betong", 1),
       (1, "Armering", 3);

INSERT INTO recycle_class (name)
VALUES ("Nytt"),
       ("Återvunnet");
...
INSERT INTO material_has_meta (meta_material_id, material_id, recycle_class_id, amount)
VALUES (1, 1, 1, 4);
...
INSERT INTO composite_has_material (composite_material_id, material_id, recycle_class_id, amount)
VALUES (1, 1, 2, 1),
       (2, 2, 1, 1),
       (3, 1, 1, 1),
       (3, 2, 1, 1);
...
DELETE FROM recycle_class WHERE id = 1;
...
DELETE FROM composite_has_material where recycle_class_id = 1;
DELETE FROM recycle_class WHERE id = 1;
DELETE FROM material WHERE id = 1;
DELETE FROM meta_material WHERE id = 1;
